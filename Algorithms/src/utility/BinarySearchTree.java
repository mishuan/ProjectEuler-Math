...
/**
 * Implements an unbalanced binary search tree. Note that all "matching" is based on the compareTo
 * method.
 * 
...
/**
 * Exception class for failed finds/removes in search trees, hash tables, and list and tree
 * iterators.
 * 
 * @author Mark Allen Weiss
 */
