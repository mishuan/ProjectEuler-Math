...
public class RandomHexGeneratorTest {
   ...
   public void setUp() throws Exception {
      ...
      matchArray = 50;
      stringLength = 20;
      magicGenerator = new RandomHexGenerator(hexArray, matchArray, stringLength, 5);
   }
   ...
   public void matchGeneratorTest() throws Exception {
      for (int i = 0; i < hexArray; i++) {
         if (magicGenerator.matchedIndex[i] > -1) {
            assertEquals(magicGenerator.matchStrings[i], magicGenerator.clientStrings[magicGenerator.matchedIndex[i]]);
         }
      }
